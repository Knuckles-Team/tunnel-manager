...
# Paths
ROOT_DIR = "/home/apps/workspace/agent-packages/agents/tunnel-manager"
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in tunnel-manager
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in tunnel-manager but are NOT registered "
