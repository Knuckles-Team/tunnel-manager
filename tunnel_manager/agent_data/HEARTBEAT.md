...
5. **Domain-Specific Checks**:
   - **Tunnel Status**: Verify that all configured tunnels are active and connected.
   - **Latency**: Check for abnormal latency or connection drops on established tunnels.
