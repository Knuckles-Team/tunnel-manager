...
OPTIONAL_MODULES = {
    "tunnel_manager.agent": "agent",
    "tunnel_manager.mcp": "mcp",
}
...
_MCP_AVAILABLE = OPTIONAL_MODULES.get("tunnel_manager.mcp") in [
    m.__name__ for m in globals().values() if hasattr(m, "__name__")
]
_AGENT_AVAILABLE = "tunnel_manager.agent" in globals()
